...
public class Token implements java.io.Serializable {
  ...
  public static Token newToken(int ofKind, String image)
  {
    switch(ofKind)
    {
       case HLConstants.NUMBER : return new NumberToken(image);
       case HLConstants.STRING  : return new StringToken(image);
       case HLConstants.IDENTIFIER  : return new IdentifierToken(image);
